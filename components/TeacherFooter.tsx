      ...
      <div className="max-w-6xl mx-auto px-5 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          ...
          <p className="text-white/80 leading-relaxed mb-4">
            iView là nền tảng luyện tập phỏng vấn và thi vấn đáp trực tuyến được phát triển bởi Trường Đại học Kinh tế Quốc dân, nhằm hỗ trợ giảng viên tạo và quản lý các buổi thi vấn đáp với công nghệ AI.
          </p>
        </div>
